...
final class Configurator extends ConfigToml implements ZeroContextRequiredInterface, BootloaderInterface
{
    ...
    {
        $this->file                 = $zeroContext->getApplicationDirectory() . '/main.toml';
        return $this;
    }
